...
// integer pairs. Elements of each pair represent the
...
// still on the bus after the last bus stop (after
// the last array). Even though it is the last bus stop,
// the bus might not be empty and some people might still
...
// The second value in the first pair in the
// array is 0, since the bus is empty in the first bus stop.

function peopleInTheBus(busStops) {
  let peopleLeft = 0;
...
console.log(peopleInTheBus(busStops));
